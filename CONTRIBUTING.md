# Contributing to Llama Searchai

Thank you for your interest in contributing to Llama Searchai! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Searchai:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-searchai.git
   cd llama-searchai
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-searchai.git
   ```
...
By contributing to Llama Searchai, you agree that your contributions will be licensed under the project's MIT License.
